package pers.husen.demo.pers.husen.demo.fastdfs;
 ...
 * @Author 何明胜
 *
 * @Created at 2018年2月13日 下午12:52:12
 * 
 * @Version 1.0.0
 */
public class FirstFastDFS {
	/**
	 * @param args
	 * @throws Exception
	 */
	public static void main(String[] args) throws Exception {
		...
		String[] files = uploadFile(file, "fdfs_client.conf", file.length());
